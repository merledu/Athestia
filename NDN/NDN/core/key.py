...
def pk_encode(rho, t1):
    ...
    for i in range(rows_k):
        ...
        #     print((simple_bit_pack(t1[i], b)).hex())
...
def KeyGen():
    ...
    ab = shake.read(32)  #256 bits = 32 bytes
