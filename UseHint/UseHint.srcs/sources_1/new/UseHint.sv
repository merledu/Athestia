...
module UseHint #(
    ...
    parameter int r1v_width  = 32    // width of each r1v output coefficient
)(
    input  logic                   clk,
    input  logic                   reset,
    input  logic   h [k-1:0][255:0],         // Hint matrix
    input  logic [r_width-1:0]     r [k-1:0][255:0], // Input polynomial matrix
    output logic [r1v_width-1:0]   r1v [k-1:0][255:0],// Output matrix
