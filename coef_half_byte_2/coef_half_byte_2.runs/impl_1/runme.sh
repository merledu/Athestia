...
HD_PWD='E:/coef_half_byte_2/coef_half_byte_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_three_bytes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_three_bytes.tcl -notrace
