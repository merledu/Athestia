...
HD_PWD='E:/coef_half_byte_2/coef_half_byte_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_three_bytes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_three_bytes.tcl
