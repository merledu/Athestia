...
HD_PWD='E:/coefficientthreebytes/coefficientthreebytes.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CoefFromThreeBytes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CoefFromThreeBytes.tcl -notrace
