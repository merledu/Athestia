...
HD_PWD='E:/coefficientthreebytes/coefficientthreebytes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CoefFromThreeBytes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CoefFromThreeBytes.tcl
