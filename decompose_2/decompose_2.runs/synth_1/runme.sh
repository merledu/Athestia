...
HD_PWD='E:/decompose_2/decompose_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decompose.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decompose.tcl
