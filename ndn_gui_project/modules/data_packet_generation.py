...
class DataPacketIcon(QLabel):
    def __init__(self, canvas, component, packet_info):
        ...
        # Set small icon image (your uploaded DP icon)
        # base_path = os.path.dirname(os.path.abspath(__file__))
