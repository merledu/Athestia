...
class KeyDetailsDialog(QDialog):
    def __init__(self, title, data, parent=None):
        ...
        icon_label = QLabel()
        icon_label.setPixmap(QPixmap("assets/key.png").scaled(48, 48, Qt.KeepAspectRatio))
...
class ComponentPanel(QScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        self.add_component_button("CA", "assets/ca.jpeg")
        self.add_component_button("Producer", "assets/producer.jpeg")
        self.add_component_button("Consumer", "assets/consumer.jpeg")
        self.add_component_button("Router", "assets/router.jpeg")
        self.add_component_button("Link", "assets/link.png")
        self.add_component_button("NDN Repo", "assets/ndn_repo.png")
        # Add Modes heading
...
class TopologyCanvas(QWidget):
    ...
    def initialize_topology(self):
        ...
        for idx, ca in enumerate(ca_nodes):
            ...
            key_icon = QLabel(ca)
            key_icon.setPixmap(QPixmap("assets/key.png").scaled(18, 18, Qt.KeepAspectRatio))
            key_icon.move(0, 0)
            key_icon.show()
        ...
        for consumer in self.get_connected_consumers(root_ca):
            ...
            self.animate_icon_along_link(root_ca, consumer, "assets/key.png", slow_ms=900)
        ...
        for ca in ca_nodes:
            ...
            self.animate_icon_along_link(ca, root_ca, "assets/key.png", slow_ms=1000)
            root_ca.message_manager.show_message("Signing PK...")
            sign_icon = QLabel(root_ca)
            sign_icon.setPixmap(QPixmap("assets/sign.png").scaled(18, 18, Qt.KeepAspectRatio))
            ...
            cert_icon.setPixmap(QPixmap("assets/certificate.jpg").scaled(18, 18, Qt.KeepAspectRatio))
            ...
            self.animate_icon_along_link(root_ca, ca, "assets/certificate.jpg", slow_ms=1000)
            ca.name_label.setText(f"{ca.name}\nCert received")
    ...
    def traverse_interest_packet(self, consumer, producer, interest_name, packet):
        ...
        for idx in range(1, len(path)):
            ...
            self.animate_icon_along_link(prev_comp, curr_comp, "assets/packet.png", slow_ms=800)
    ...
    def traverse_data_packet(self, producer, data_packet_icon):
        ...
        while current_component:
            ...
            if current_component.component_type == "Producer":
                ...
                self.animate_icon_along_link(current_component, next_component, "assets/packet.png", slow_ms=800)
