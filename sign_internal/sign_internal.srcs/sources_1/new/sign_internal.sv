...
//    logic skdone, initiator, nttdone, rst_ntt, ntt_disabler;
//    logic s1_ntt_done, s2_ntt_done, expanda_done,shakeRst,shake_start2,shakeRst2;
//    logic [3:0]  counts1, newcount;
//    logic [4:0]  count_rst;
...
//    logic shakeDone, shakeStart,shakeDone2;
//    logic [511:0] tr;
//    logic [255:0] K;
...
//        // Block 1: expandA_rst logic
//        if (skdone && expandA_rst === 'x) begin
//            expandA_rst <= 1;
////            shakeRst <= 1; 
//            $display("shakein: %h",{msg,tr});
//            shakeStart <= 1;  
////            shake_start2 <=shakeStart;      
//        end
