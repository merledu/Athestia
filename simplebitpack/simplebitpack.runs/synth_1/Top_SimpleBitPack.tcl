...
synth_design -top Top_SimpleBitPack -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef Top_SimpleBitPack.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Top_SimpleBitPack_utilization_synth.rpt -pb Top_SimpleBitPack_utilization_synth.pb"
