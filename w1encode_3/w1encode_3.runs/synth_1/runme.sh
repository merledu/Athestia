...
HD_PWD='E:/w1encode_3/w1encode_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log w1encode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source w1encode.tcl
